...
//BEWARE OF TIMEOUTS, WRITE EXPECTATIONS UPFRONT -->> TESTING VALUE/CHANGENOTIFIER IS MORE INTUITIVE
  test(
      'WHEN email is updated'
      'AND password is updated'
      'AND submit is called'
      'THEN modelStream emits the correct events', () async {
    when(mockAuth.signInWithEmailAndPassword(any, any)) //updateWith , exception
        .thenThrow(PlatformException(code: 'ERROR'));
    expect(
        bloc.modelStream,
        emitsInOrder([
          //emit is expect in streams
          EmailSignInModel(),
